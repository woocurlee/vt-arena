...
| 항목 | Virtual Thread (Tomcat) | Coroutine (Netty) |
|------|------------------------|-------------------|
| 100 VUs 평균 응답시간 | 3006.71ms | 3003.47ms |
| 500 VUs 평균 응답시간 | 3005.22ms | 3002.23ms |
| 1000 VUs 평균 응답시간 | 3006.54ms | 3002.35ms |
| 1000 VUs p99 | 3044.44ms | 3007.90ms |
| 최대 TPS | 347 | 350 |
...
| 항목 | synchronized (pinning) | ReentrantLock (no pinning) |
|------|----------------------|---------------------------|
| 100 VUs 평균 응답시간 | 5,057ms | 6,813ms |
| 500 VUs 평균 응답시간 | 20,973ms | 21,364ms |
| 1000 VUs 평균 응답시간 | 42,787ms | 35,661ms |
| 1000 VUs p99 | 59,998ms | 52,763ms |
| 최대 TPS | 960 | 20 |
| 총 요청 수 | 2,090 | 2,913 |
